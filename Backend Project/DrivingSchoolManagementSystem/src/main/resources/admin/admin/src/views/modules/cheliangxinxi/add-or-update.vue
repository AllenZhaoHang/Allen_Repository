  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="车型" prop="chexing">
              <el-input v-model="ruleForm.chexing" 
                placeholder="车型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="使用时长" prop="shiyongshizhang">
          <el-input v-model="ruleForm.shiyongshizhang" 
              placeholder="使用时长" clearable  :readonly="ro.shiyongshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="使用时长" prop="shiyongshizhang">
              <el-input v-model="ruleForm.shiyongshizhang" 
                placeholder="使用时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="维修信息" prop="weixiuxinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.weixiuxinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weixiuxinxi" label="维修信息" prop="weixiuxinxi">
                    <span v-html="ruleForm.weixiuxinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chepaihao = true;
          ...
          if(o=='shiyongshizhang'){
            this.ruleForm.shiyongshizhang = obj[o];
	    this.ro.shiyongshizhang = true;
            continue;
          }
          if(o=='weixiuxinxi'){
            this.ruleForm.weixiuxinxi = obj[o];
	    this.ro.weixiuxinxi = true;
            continue;
          }
          if(o=='zhaopian'){
	...
	this.ruleForm.weixiuxinxi = this.ruleForm.weixiuxinxi.replace(reg,'../../../springbooto2ehg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
