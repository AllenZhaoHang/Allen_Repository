<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="驾校电话" prop="jiaxiaodianhua">
          <el-input v-model="ruleForm.jiaxiaodianhua" 
              placeholder="驾校电话" clearable  :readonly="ro.jiaxiaodianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="驾校电话" prop="jiaxiaodianhua">
              <el-input v-model="ruleForm.jiaxiaodianhua" 
                placeholder="驾校电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jiaxiaotupian" label="驾校图片" prop="jiaxiaotupian">
          ...
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.jiaxiaotupian?ruleForm.jiaxiaotupian:''"
          @change="jiaxiaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="驾校介绍" prop="jiaxiaojieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiaxiaojieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaxiaojieshao" label="驾校介绍" prop="jiaxiaojieshao">
                    <span v-html="ruleForm.jiaxiaojieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaxiaomingcheng = true;
          ...
          if(o=='jiaxiaoleixing'){
            this.ruleForm.jiaxiaoleixing = obj[o];
	    this.ro.jiaxiaoleixing = true;
            continue;
          }
          if(o=='jiaxiaodizhi'){
	    ...
	    this.ro.baomingfeiyong = true;
          ...
          if(o=='jiaxiaojieshao'){
            this.ruleForm.jiaxiaojieshao = obj[o];
	    this.ro.jiaxiaojieshao = true;
            continue;
          }
          if(o=='jiaxiaodianhua'){
            this.ruleForm.jiaxiaodianhua = obj[o];
	    this.ro.jiaxiaodianhua = true;
            continue;
          }
          if(o=='jiaxiaotupian'){
	...
	this.ruleForm.jiaxiaojieshao = this.ruleForm.jiaxiaojieshao.replace(reg,'../../../springbooto2ehg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jiaxiaotupian!=null) {
		this.ruleForm.jiaxiaotupian = this.ruleForm.jiaxiaotupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    jiaxiaotupianUploadChange(fileUrls) {
	this.ruleForm.jiaxiaotupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
