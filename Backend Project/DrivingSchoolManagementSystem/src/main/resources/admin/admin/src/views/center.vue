<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="账号" prop="zhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="教练工号" prop="jiaoliangonghao">
          <el-input v-model="ruleForm.jiaoliangonghao" readonly              placeholder="教练工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaolian'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="指导科目" prop="zhidaokemu">
          <el-input v-model="ruleForm.zhidaokemu"               placeholder="指导科目" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.jiaoliangonghao)&& 'jiaolian'==this.flag){
      ...
      if( 'jiaolian' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
        if(this.ruleForm.touxiang!=null) {
