<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="打卡类型" prop="dakaleixing">
          <el-select :disabled="ro.dakaleixing" v-model="ruleForm.dakaleixing" placeholder="请选择打卡类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="打卡类型" prop="dakaleixing">
	      <el-input v-model="ruleForm.dakaleixing"
                placeholder="打卡类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="打卡地点" prop="dakadidian">
          <el-input v-model="ruleForm.dakadidian" 
              placeholder="打卡地点" clearable  :readonly="ro.dakadidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="打卡地点" prop="dakadidian">
              <el-input v-model="ruleForm.dakadidian" 
                placeholder="打卡地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dakaleixing = true;
          ...
          if(o=='dakadidian'){
            this.ruleForm.dakadidian = obj[o];
	    this.ro.dakadidian = true;
            continue;
          }
          if(o=='dakashijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kaoqindaka/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kaoqindakaCrossAddOrUpdateFlag = false;
						 this.parent.search();
