<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="练车时间" prop="liancheshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.liancheshijian" 
                type="datetime"
                :readonly="ro.liancheshijian"
                placeholder="练车时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.liancheshijian" label="练车时间" prop="liancheshijian">
              <el-input v-model="ruleForm.liancheshijian" 
                placeholder="练车时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="预约说明" prop="yuyueshuoming">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yuyueshuoming" label="预约说明" prop="yuyueshuoming">
                    <span>{{ruleForm.yuyueshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaolianxingming = true;
          ...
          if(o=='liancheshijian'){
            this.ruleForm.liancheshijian = obj[o];
	    this.ro.liancheshijian = true;
            continue;
          }
          if(o=='yuyueshuoming'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuyuelianche/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuyueliancheCrossAddOrUpdateFlag = false;
						 this.parent.search();
