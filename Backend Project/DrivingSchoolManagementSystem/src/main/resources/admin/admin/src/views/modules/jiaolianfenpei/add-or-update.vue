<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="教练工号" prop="jiaoliangonghao">
          <el-select :disabled="ro.jiaoliangonghao" @change="jiaoliangonghaoChange" v-model="ruleForm.jiaoliangonghao" placeholder="请选择教练工号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jiaoliangonghao" label="教练工号" prop="jiaoliangonghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指导科目" prop="zhidaokemu">
          <el-input v-model="ruleForm.zhidaokemu" 
              placeholder="指导科目" clearable  :readonly="ro.zhidaokemu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指导科目" prop="zhidaokemu">
              <el-input v-model="ruleForm.zhidaokemu" 
                placeholder="指导科目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    // 下二随
    jiaoliangonghaoChange () {
      this.$http({
        url: `follow/jiaolian/jiaoliangonghao?columnValue=`+ this.ruleForm.jiaoliangonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaolianfenpei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaolianfenpeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
