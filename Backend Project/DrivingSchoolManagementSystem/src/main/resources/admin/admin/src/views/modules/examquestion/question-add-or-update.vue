<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择练习题库" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择练习题库">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择练习题库", trigger: "blur" }],
        questionname: [
