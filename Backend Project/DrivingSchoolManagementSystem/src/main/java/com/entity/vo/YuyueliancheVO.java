 ...
 */
public class YuyueliancheVO  implements Serializable {
	...
	public void setLiancheshijian(Date liancheshijian) {
		this.liancheshijian = liancheshijian;
	}
	
	/**
	 * 获取：练车时间
	 */
	public Date getLiancheshijian() {
		return liancheshijian;
	}
