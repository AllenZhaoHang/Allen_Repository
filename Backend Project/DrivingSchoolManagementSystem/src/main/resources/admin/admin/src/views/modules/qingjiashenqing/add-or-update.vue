  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qingjiashijian" label="请假时间" prop="qingjiashijian">
              <el-input v-model="ruleForm.qingjiashijian" 
                placeholder="请假时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
