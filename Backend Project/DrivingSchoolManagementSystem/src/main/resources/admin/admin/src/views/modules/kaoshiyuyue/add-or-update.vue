<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试地点" prop="kaoshididian">
          <el-input v-model="ruleForm.kaoshididian" 
              placeholder="考试地点" clearable  :readonly="ro.kaoshididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考试地点" prop="kaoshididian">
              <el-input v-model="ruleForm.kaoshididian" 
